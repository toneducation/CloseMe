-- CloseMe social profile polish: Instagram links, resilient inbox access and privacy-safe photo diagnostics.
begin;
...
-- Pausing discovery must not make the owner's Likes / Matches / Chats screens unusable.
