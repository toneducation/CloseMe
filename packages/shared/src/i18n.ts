...
const en = {
  ...
  done: "Your username is registered: @{username}. Profile creation will open after the next setup phase. Discovery and messaging are not yet enabled.",
...
const uz: Dictionary = {
  ...
  done: "Username ro‘yxatdan o‘tdi: @{username}. Profil yaratish keyingi sozlash bosqichidan so‘ng ochiladi. Qidiruv va xabarlar hali yoqilmagan.",
...
const ru: Dictionary = {
  ...
  done: "Имя зарегистрировано: @{username}. Создание профиля откроется после следующего этапа настройки. Поиск и сообщения пока недоступны.",
